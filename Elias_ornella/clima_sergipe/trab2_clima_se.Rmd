...
Vale mencionar que testamos os métodos de inputação via interpolação por splines, por médias móveis e suavição de Kalman, mas o que melhor se adaptou às dinâmicas das séries foi o método por interpolação linear.
